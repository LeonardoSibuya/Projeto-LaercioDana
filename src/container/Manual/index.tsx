...
const Manual = () => (
  <S.DivContent>
    ...
    <S.ManualContainer>
      <S.TabelaContainer>
        <S.Tabela>
          ...
          <tbody>
            ...
            <tr>
              <td>20</td>
              <td>Semieixo Completo LD/LE (30 estrias, 5 furos, 732mm)</td>
              <td>BA203287 </td>
            </tr>
            <tr>
              <td>20</td>
            ...
            <tr>
              <td>20</td>
              <td>Semieixo Completo LD (30 estrias, 5 furos, 694mm) </td>
              <td>BA203338-2</td>
            </tr>
            <tr>
              <td>20</td>
            ...
            <tr>
              <td>25</td>
              <td>
                Caixa Dif Completa (OT - furo parafuso 10,2 mm - planetária 30
                estrias)
              </td>
              <td>BA202934</td>
            </tr>
            <tr>
              <td>25</td>
              <td>
                Caixa Dif Completa (OT - furo parafuso 11,8 mm - planetária 30
                estrias)
              </td>
              <td>BA203301</td>
            </tr>
            ...
            <tr>
              <td>34</td>
              <td>Bujão mag. furo quad. 9,8 mm (rosca NPTF 1/2 - 14) </td>
              <td>43181</td>
            </tr>
            <tr>
              <td>34</td>
            ...
            <tr>
              <td>38</td>
              <td>
                Kit de Reparo de Caixa Diferencial OT (estrias internas na
                planetária = 30)
              </td>
              <td>BA401178-X</td>
            </tr>
            ...
            <tr>
              <td>44</td>
              <td>
                Kit de Reparo de Caixa Diferencial TL (estrias internas na
                planetária = 30)
              </td>
              <td>BA401186-X</td>
            </tr>
      ...
      <S.DivImage>
        <img src={ManualConvencional} alt="" />
      </S.DivImage>
    </S.ManualContainer>
        ...
        <S.Tabela>
          ...
          <tbody>
            ...
            <tr>
              <td>25</td>
              <td>
                Caixa Dif Completa (TL - furo parafuso 10,2 mm - planetária 30
                estrias)
              </td>
              <td>BA202835</td>
            </tr>
            ...
            <tr>
              <td>25</td>
              <td>
                Caixa Dif Completa a (TL - furo parafuso 11,8 mm - planetária 30
                estrias)
              </td>
              <td>BA203681</td>
            </tr>
            ...
            <tr>
              <td>34</td>
              <td>
                Bujão magnético furo quadrado 9,8 mm (rosca NPTF 1/2 - 14)
              </td>
              <td>43181</td>
            </tr>
            <tr>
